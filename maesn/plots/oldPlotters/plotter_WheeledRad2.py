...
#plt.ylim(-1000, -700)
plt.title("WheeledRad2-trainedOn20")
...
trpo = plot("/home/russellm/maml_rl_baseline_test/data/local/TRPO-wheeled-robot0.01radius2/", "Task", 100)
...
plt.plot(np.arange(0,50), np.mean(masen1, 0), label = "masen_ldim2_kl0.1")
...
plt.legend()
plt.savefig("WheeledRad2-trainedOn20-trainSetPerformance.png")
