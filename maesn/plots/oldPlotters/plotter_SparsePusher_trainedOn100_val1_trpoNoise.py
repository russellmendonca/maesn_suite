...
plt.plot(np.arange(3,100), np.mean(trpoMasenImprove,0), label = "masenTRPO")
#plt.plot(np.arange(2,100), np.mean(trpoMamlImprove,0), label = "mamlTRPO")
...
plt.legend()
plt.savefig("randSparsePusher-trainedOn100-valSet1-trpoNoise.png")
