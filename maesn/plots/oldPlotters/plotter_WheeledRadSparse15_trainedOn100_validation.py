...
trpoSparse = plot("/home/russellm/maml_rl_baseline_test/data/local/TRPO-wheeled-robot-100goals0.01radius2-Sparse1-5/", "Task", 100)
...
mamlBiasBiasADA = plot("/home/russellm/new_maml_rl_baseline/data/local/MamlTest100itr-Bias-BiasADA-SparseRad15-wheeledRad2-lr0.1-halfStep-trainedOn100-itr499/", "", 100)


#mamlBiasFullADA = plot()
...
plt.legend()
plt.savefig("WheeledRad2-trainedOn100-SparseRad15.png")
