...
#folders = ['3-lr0.1']
_file = '/home/russellm/generativemodel_tasks/maml_rl_fullversion/data/local/blockpush-adaStep/fulltrpomaml1_ldim_2_fbs100_mbs10_flr_1.0metalr_0.01_step11kl_schemeNonekl_weighting0.1'
...
plt.plot(Iterations, ret0, label = "Average0 Reward")
...
plt.legend()    
plt.savefig("blockPush_ldim_2_kl_0.1.png")
