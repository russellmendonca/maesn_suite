...
#trpoSparse = plot("/home/russellm/maml_rl_baseline_test/data/local/TRPO-wheeled-robot-Sparse-wrtGoal100.01radius2/", "Task", 100)
...
LS = plot("/home/russellm/generativemodel_tasks/maml_rl_fullversion/data/local/TrainDenseTestSparse-LSBaseline-wheeled-trainedOn100-meta20-Val-ldim2-kl0.01-itr320/", "", 10)
...
#masen = plot("/home/russellm/generativemodel_tasks/maml_rl_fullversion/data/local/MasenWheeledTestSparse1-Radius2-trainedOn100-ldim2-kl0.5-itr300/", "", 10) 


masen = plot("/home/russellm/generativemodel_tasks/maml_rl_fullversion/data/local/MasenWheeled-TestSparse-wrtGoal10-trainedOn100-ldim2-kl0.5-itr320/", "", 15)
...
#plotMeanStd(10, trpoSparse, "trpo")
#plotMeanStd(100, maml, "maml")
plotMeanStd(15, masen, "masen")
#plotMeanStd(10, LS, "LS")




plt.legend()
plt.savefig("WheeledRad2-trainedOn100-Indicator-Rad1.png")
