...
class WheeledEnvGoal(MujocoEnv, Serializable):
    ...
    def __init__(self, goal=None, *args, **kwargs):
        ...
        self.goals = pickle.load(open('/home/russellm/generativemodel_tasks/maml_rl_fullversion/rllab/envs/mujoco/100goals_wheeled_rad2_ValSet.pkl', 'rb'))
    ...
    def sample_goals(self, num_goals):
        ...
        #return np.array([9, 87, 43, 88, 77, 33, 75, 6, 80, 68, 40, 25, 90, 65, 27, 31, 62, 48, 51, 84])
    ...
    def step(self, action):
        ...
        dense_reward = -np.linalg.norm(next_obs[:2] - self.goals[self._goal_idx]) - ctrl_cost 
            
        done = False
        return Step(next_obs, reward, done, distanceReward = distanceRew, dense_reward = dense_reward)
