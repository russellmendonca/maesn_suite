...
from rllab.envs.mujoco.pusher_env_morerandom_subsample_ec2_new import  PusherEnvRandomized
    ...
    for latent_dim in latent_dims:
        for kl_weighting in kl_weightings:
            ...
            run_experiment_lite(
                ...
                seed=1,
                exp_prefix='masen_randPushRedone_train100_subsampling20',
                exp_name='fulltrpomasen'+str(int(use_maml))+'_ldim_'+str(latent_dim)+'_fbs'+str(fast_batch_size)+'_mbs'+str(meta_batch_size)+'_flr_' + str(fast_learning_rate) + 'metalr_' + str(meta_step_size) +'_step1'+str(num_grad_updates) + "kl_scheme" + str(kl_scheme) + "kl_weighting" + str(kl_weighting)+"_seed"+str(seed),
                plot=False,
                sync_s3_pkl=True,
                mode="ec2",
