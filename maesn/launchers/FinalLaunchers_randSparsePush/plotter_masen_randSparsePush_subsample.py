...
for latent_dim in latent_dims:
    for kl_weighting in kl_weightings:
        ...
        initial_params_file ="/home/russellm/generativemodel_tasks/maml_rl_fullversion/data/s3/masen-randSparsePush-train100-subsampling20/fulltrpomasen1_ldim_"+str(latent_dim)+"_fbs20_mbs20_flr_1metalr_0.01_step11kl_schemeNonekl_weighting"+str(kl_weighting)+"/itr_399.pkl"
        ...
        algo = MAMLTRPO(
            ...
            kl_scheme=kl_scheme,
            visitationFolder = "randPushMasen",
            visitationFile = "ldim"+str(latent_dim)+"_kl"+str(kl_weighting)+"_itr399",
            #plottingFolder = "RandPushSparse"
        )
        run_experiment_lite(
            algo.train(),
            n_parallel=4,
