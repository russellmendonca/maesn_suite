...
from rllab.envs.mujoco.ant_env_rand_goal_ring_maesn_dense_L2loss import AntEnvRandGoalRing
import tensorflow as tf

fast_learning_rates = [1 , 0.5, 0.1]
baselines = ['linear']
    ...
    for latent_dim in latent_dims:
        for kl_weighting in kl_weightings:
            ...
            run_experiment_lite(
                ...
                seed=1,
                exp_prefix='maesn_l2Loss_ant_radius2_tasks100_metaTrain20',
