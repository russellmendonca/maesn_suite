...
#from rllab.envs.mujoco.pusher_env_morerandom_sparse_val1_wrtgoal20_ec2 import  PusherEnvRandomized
...
for goal in goals:
    ...
    initial_params_file = "/root/code/rllab/metaTrainedPolicies/LS_ant.pkl'"
    env =  AntEnvRandGoalRing()
    ...
    run_experiment_lite(
        ...
        # will be used
        seed=1,
        exp_prefix="LSBaselineAnt_Ind8_ldim"+str(ldim),
