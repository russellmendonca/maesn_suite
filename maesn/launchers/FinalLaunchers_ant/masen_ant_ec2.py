...
from rllab.envs.mujoco.ant_env_rand_goal_ring_maesn import  AntEnvRandGoalRing
import tensorflow as tf

fast_learning_rates = [0.1, 1 , 0.5]
baselines = ['linear']
...
#initFile= '/home/russellm/generativemodel_tasks/maml_rl_fullversion/rllab/envs/mujoco/masen_ant.pkl'
...
for fast_learning_rate in fast_learning_rates:
    for seed in seeds:
        ...
        run_experiment_lite(
            ...
            seed=seed,
            exp_prefix='maesn_ant_radius2_tasks100_metaTrain20_seedTest',
            exp_name='fulltrpomasen'+str(int(use_maml))+'_seed'+str(seed)+'_ldim_'+str(latent_dim)+'_fbs'+str(fast_batch_size)+'_mbs'+str(meta_batch_size)+'_flr_' + str(fast_learning_rate) + 'metalr_' + str(meta_step_size) +'_step1'+str(num_grad_updates) + "kl_scheme" + str(kl_scheme) + "kl_weighting" + str(kl_weighting),
            plot=False,
            sync_s3_pkl=True,
            mode="ec2",
